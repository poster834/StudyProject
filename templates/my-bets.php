...
<div class="page-wrapper">
  ...
  <main>
    ...
    <section class="rates container">
      ...
      <?php if ($bet['rates'] == 'active'):?>
        <tr class="rates__item">
          <td class="rates__info">
            <div class="rates__img">
              <img src="uploads/<?=$bet['lot_image']?>" width="54" height="40" alt="<?=$bet['category_name']?>">
            </div>
          ...
          <?php if (get_dt_range($bet['date_finish'])['hours'] < 1): ?>
            <div class="timer timer--finishing">
            <?=get_dt_range($bet['date_finish'])['hours'].":".get_dt_range($bet['date_finish'])['minutes'];?>
            </div>
            <?php else:?>
              <div class="timer">
            <?=get_dt_range($bet['date_finish'])['hours'].":".get_dt_range($bet['date_finish'])['minutes'];?>
