  ...
  <main>
    <nav class="nav">
      ...
      <?php foreach($category as $cat):?>
                <li class="nav__item">
                    <a href="all_lots.php?category_id=<?=$cat['id']?>"><?=$cat['name'];?></a>
                </li>
            <?php endforeach;?>
      </ul>
    </nav>
      ...
      <div class="lot-item__content">
        <div class="lot-item__left">
          <div class="lot-item__image">
            <img src="../uploads/<?=$lot['lotImage']?>" width="730" height="548" alt="Сноуборд">
          </div>
        ...
        <div class="lot-item__right">
          ...
          <?php if($lot['winner_id'] == NULL):?>
            ...
            <?php else:?>
                ...
                <?=date('d-m-Y 23:59', strtotime($lot['date_finish']));?>
                </div>
            <?php endif;?>
          <?php else:?>
            <div class="lot__timer timer">
          ...
          <?php endif;?>
            <div class="lot-item__cost-state">
              <div class="lot-item__rate">
                ...
                <span class="lot-item__cost"><?=priceFormatter($lot['price']);?><b class='rub'>p.</b></span>
              </div>
              <div class="lot-item__min-cost">
                Мин. ставка <span><?=priceFormatter($lot['price'] + $lot['step']);?><b>p.</b></span>
              </div>
            </div>
            <?php if ( isset($is_auth) && $is_auth == 1 ):?>
              <?php if ( $user_id <> $lot['user_id'] && $last_bet_user_id <> $user_id && $lot['winner_id'] == NULL):?>
              ...
              <p class="lot-item__form-item form__item <?=$errors[cost];?>"> <!--form__item--invalid -->
                ...
                <input type="hidden" name="lot-id" value="<?=$lot['lotID']?>">
          ...
          <div class="history">
            ...
            <?php foreach($bets as $bet):?>
              <tr class="history__item">
                ...
                <td class="history__price"><?=priceFormatter($bet['cost_bet']);?>р.</td>
                <td class="history__time"><?=$bet['age']?></td>
