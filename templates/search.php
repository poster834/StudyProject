          ...
          <?php foreach($lots as $lot):?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="uploads/<?=filterXSS($lot['image']);?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$category[filterXSS($lot['category'])]?></span>
                    <h3 class="lot__title"><a class="text-link" href="lot.php?id=<?=$lot['id']?>"><?=filterXSS($lot['name'])?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">стартовая цена</span>
                            <span class="lot__cost"><?=priceFormatter(filterXSS($lot['price']));?></span>
                        </div>
