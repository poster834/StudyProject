...
<div class="page-wrapper">
  ...
  <main>
    ...
    <form enctype="multipart/form-data" action="../add.php" method="POST" class="form form--add-lot container <?=$form_invalid?>">
      ...
      <input name="submit" type="submit" class="button" value='Добавить лот'>
    </form>
  </main>
